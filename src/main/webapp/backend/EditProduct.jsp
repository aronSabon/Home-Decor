      ...
      <div class="card">
            <div class="card-body">
              ...
              <!-- Floating Labels Form -->
               <form action="${pageContext.request.contextPath}/backend/EditProductServlet"  method="post"  class="row g-3" enctype="multipart/form-data">
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="floatingName" name="name" value="${product.name}" placeholder="Product Name" required>
                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="number" class="form-control" name="price" value="${product.price}" id="price" placeholder="Price" required>
                ...
                <input type="hidden" name="oldImageName" value="${product.imageName}">
