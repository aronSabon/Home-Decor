				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						<li class="nav-item active">
							<a class="nav-link" href="DashboardServlet">Home</a>
						</li>
						<li><a class="nav-link" href="AllProductServlet">Shop</a></li>
						<li><a class="nav-link" href="AboutUsServlet">About us</a></li>
						<li><a class="nav-link" href="ServicesServlet">Services</a></li>
						<li><a class="nav-link" href="ContactUsServlet">Contact us</a></li>
					</ul>

					<ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
						<li><a class="nav-link" href="#"><img src="static/images/user.svg"></a></li>
						<li><a class="nav-link" href="CartServlet"><img src="static/images/cart.svg"></a></li>
					</ul>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
						...
						<p class="mb-4">Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate velit imperdiet dolor tempor tristique. </p>
						<p><a href="AllProductServlet" class="btn">View All</a></p>
					</div> 
					<!-- End Column 1 -->
											...
											<div class="testimonial-block text-center">
												...
												<div class="author-info">
													<div class="author-pic">
														<img src="static/images/person-1.png" alt="Maria Jones" class="img-fluid">
													</div>
				...
				<div class="row">
					...
					<div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
						<div class="post-entry">
							<a href="#" class="post-thumbnail"><img src="static/images/post-1.jpg" alt="Image" class="img-fluid"></a>
					...
					<div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
						<div class="post-entry">
							<a href="#" class="post-thumbnail"><img src="static/images/post-2.jpg" alt="Image" class="img-fluid"></a>
							<div class="post-content-entry">
					...
					<div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
						<div class="post-entry">
							<a href="#" class="post-thumbnail"><img src="static/images/post-3.jpg" alt="Image" class="img-fluid"></a>
							<div class="post-content-entry">
